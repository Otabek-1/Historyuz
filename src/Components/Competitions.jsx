        ...
        <div key={comp.id} className="w-full competitions-card mb-5">
            <div className="flex flex-col md:flex-row items-center gap-4">
                ...
                >
                    ...
                    <Link to={`/competition/${comp.id}`} className="px-4 py-2 bg-green-600 text-white rounded-full border-2 border-green-600 text-sm md:text-lg transition-all hover:bg-white hover:text-green-600">
                        Qatnashish
                    </Link>
                </div>
